...
<body>
    ...
    <div class="container mx-auto">
        ...
        @if (session('mensagem'))
            <div class="flex justify-between items-center p-2 bg-green-500 text-white border-2 border-green-500 rounded-sm">
                <span class="text-xs">{{ session('mensagem') }}</span>
            </div>
